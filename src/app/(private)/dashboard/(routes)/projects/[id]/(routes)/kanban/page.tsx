...
function KanbanBoard() {
  ...
  return (
    <div className="flex flex-col gap-2 h-full w-full items-start overflow-x-auto overflow-y-hidden">
      ...
      >
        <div className="flex-col md:flex-row items-start flex gap-4 h-full">
